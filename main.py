...
class InputData(BaseModel):
    ...
    age: int = Field(None, example=25)
    workclass: str = Field(None, example='State-gov')
    fnlgt: int = Field(None, example=54545)
    ...
    capital_gain: int = Field(None, example=420)
    capital_loss: int = Field(None, example=200)
    hours_per_week: int = Field(None, example=45)
    native_country: str = Field(None, example='Bharat')
